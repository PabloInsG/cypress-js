...
describe('Primer conjunto de casos de prueba', function () {
    ...
    it('Verificar que los dropdowns de arreglo esten funcionando', function () {
        ...
        */
        ...
        // Para tamaño de hijos de un elemento .should('have.length', x)
        // Crear un parametro de un elemento .as('Nombrequequeramos')
        //Para mencionar este parametro cy.get('@Nombrequelehemospuesto')
